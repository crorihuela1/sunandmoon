...
CONFIG_DIR = Path(os.environ.get("SUNMOON_CONFIG_DIR", REPO_ROOT / "config"))
STATE_DIR = Path(os.environ.get("SUNMOON_STATE_DIR", REPO_ROOT / "state"))
QUEUE_DIR = Path(os.environ.get("SUNMOON_QUEUE_DIR", REPO_ROOT / "queue"))
